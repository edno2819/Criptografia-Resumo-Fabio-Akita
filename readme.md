...
Essa informação é importante, pois muitos dos algorítimos sendo utilizados tem como finalidade dificultar e tornar inviável computacionalmente ou financeiramente(custos em manter o funcionamento desses hardawares) os ataques de força bruta.
